...
<body>
  ...
  <a href="add_admin"><i class="fa fa-user-plus"></i> Add Admin</a>
...
<div class="content">
	<i class="fa fa-dashboard" style="font-size: 40px;color:white;position: fixed;">Dashboard/</i><br>
<a href="add_admin" class="button"><i class="fa fa-plus"></i> Add Admin</a>
<a href="view_user" class="button" style="margin-left: 240px;background-color: #33acb7;border-radius: 10px;padding-left: 80px;position: fixed;"><i class="fa fa-eye"></i> View User</a>
<a href="feedback" class="button" style="margin-left: 490px;background-color: #ff8832;"><i class="fa fa-send"></i> Feedback&nbsp&nbsp&nbsp</a>
<a href="change_pwd" class="button" style="margin-left: 735px;background-color: #684c4c;padding-left:20px"><i class="fas fa-key"></i> Change Password</a>
<img src="image/welcome2.png" style="position: fixed; margin-top: 300px;margin-left: 230px">
