...
<div class="content">
  <i class="fa fa-eye" style="font-size: 40px;color: #2A3F54;margin-bottom: 10px;margin-left: 0px">View User/</i><br>
<?php
require("conn.php");
$sql="select * from user_table";
$record=mysqli_query($con,$sql);
echo "<table style='border:1px solid #ddd;background-color:#F1F1F1'>";
echo "<tr style='background-color:green;color:white'><th>Name</th><th>User_id</th><th>Mob_no</th><th>Email</th><th>Action</th></tr>";
...
echo "<td>".$row[8]."</td>";
?>
<td><a href="del.php?email=<?php echo $row['email']; ?>" onclick="return confirm('Are you sure to Delete ?');"><i class="fa fa-trash"> Delete</a></td>
<?php
echo "</tr>";
}
echo "</table>";
?>
<a href="export.php"><i class="fa fa-download"></i> Export</a>
</div></div>
