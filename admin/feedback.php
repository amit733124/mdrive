...
<div class="content">
  <i class="fa fa-comments-o" style="font-size: 40px;color: #2A3F54;margin-bottom: 10px;margin-left: 0px">Feedback/</i><br>
<?php
require("conn.php");
$sql="select * from feedback";
$record=mysqli_query($con,$sql);
echo "<table style='border:1px solid #ddd;background-color:#F1F1F1;width:auto'>";
echo "<tr style='background-color:green;color:white'><th>Name</th><th>Email</th><th>Rate</th><th>Comments</th><th>User</th><th>Date_Time</th><th>Action</th></tr>";
...
echo "<td>".$row[8]."</td>";
?>
<td><a href="replay2.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure to Replay ?');"><i class="fa fa-send-o"> Send</a></td>
<?php
echo "</tr>";
}
echo "</table>";
?>
<a href="export_feed.php"><i class="fa fa-download"></i> Export</a>
</div></div>
